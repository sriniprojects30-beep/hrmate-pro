...
export default function SignupPage() {
  ...
  useEffect(() => {
    document.title = 'Create Account | HRMATE PRO';
  }, []);
  ...
  return (
    ...
    >
      <div className="mb-6 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-1">Join HRMATE PRO today</p>
      </div>
      ...
      <form onSubmit={handleSignup} className="space-y-4">
        ...
        <div className="flex items-start space-x-2 pt-2">
          <input
            ...
            className="mt-1 rounded border-input text-primary focus:ring-primary/50 bg-background/50"
          />
